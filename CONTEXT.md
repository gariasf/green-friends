...
**Species**:
A read-only catalog entry (colloquial + scientific name) bundled with the app, carrying care defaults and whether it is toxic to pets, or that no reference settles it (no pet badge then). Never user-editable.
